...
Route::namespace ('Frontend')->middleware(['siteisclosed', 'checker'])->group(function ()
{
    ...
    try {
        $reg_enabled = settings('reg_enabled');
    } catch (\Exception $e) {
        $reg_enabled = true;
    }
    if ($reg_enabled || true)
    ...
    */
    ...
    Route::get('/netflix', ['as' => 'frontend.game.netflix', 'uses' => 'GamesController@netflix']);
...
Route::redirect('/netpos', '/backend/user')->name('netpos');
        ...
        */
        ...
        /*
         * Per-Shop Game & Bonus Settings
         */
        Route::get('shop-settings', ['as' => 'backend.shop-settings.overview', 'uses' => 'ShopGameSettingsController@overview']);
        Route::get('shop-settings/fish', ['as' => 'backend.shop-settings.fish', 'uses' => 'ShopGameSettingsController@fishSettings']);
        Route::post('shop-settings/fish', ['as' => 'backend.shop-settings.fish.update', 'uses' => 'ShopGameSettingsController@updateFishSettings']);
        Route::get('shop-settings/bonus', ['as' => 'backend.shop-settings.bonus', 'uses' => 'ShopGameSettingsController@bonusSettings']);
        Route::post('shop-settings/bonus', ['as' => 'backend.shop-settings.bonus.update', 'uses' => 'ShopGameSettingsController@updateBonusSettings']);
        Route::get('shop-settings/game-rtp', ['as' => 'backend.shop-settings.game-rtp', 'uses' => 'ShopGameSettingsController@gameRtp']);
        Route::post('shop-settings/game-rtp', ['as' => 'backend.shop-settings.game-rtp.update', 'uses' => 'ShopGameSettingsController@updateGameRtp']);
