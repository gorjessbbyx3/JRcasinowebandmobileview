<aside class="main-sidebar">
    ...
    <!-- /.search form -->
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @if( !(auth()->check() && auth()->user()->shop_id == 0 && auth()->user()->role_id < 6 ) )
            <li class="treeview {{ Request::is('backend/shop-settings*') ? 'active' : '' }}">
                <a href="#">
                    <i class="fa fa-cogs" style="color:#f39c12"></i>
                    <span style="color:#f39c12;font-weight:600">Shop Settings</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li class="{{ Request::is('backend/shop-settings') ? 'active' : '' }}">
                        <a href="{{ route('backend.shop-settings.overview') }}">
                            <i class="fa fa-circle-o"></i>
                            <span>Overview</span>
                        </a>
                    </li>
                    <li class="{{ Request::is('backend/shop-settings/fish') ? 'active' : '' }}">
                        <a href="{{ route('backend.shop-settings.fish') }}">
                            <i class="fa fa-circle-o"></i>
                            <span>Fish Game Settings</span>
                        </a>
                    </li>
                    <li class="{{ Request::is('backend/shop-settings/bonus') ? 'active' : '' }}">
                        <a href="{{ route('backend.shop-settings.bonus') }}">
                            <i class="fa fa-circle-o"></i>
                            <span>Bonus Settings</span>
                        </a>
                    </li>
                    <li class="{{ Request::is('backend/shop-settings/game-rtp') ? 'active' : '' }}">
                        <a href="{{ route('backend.shop-settings.game-rtp') }}">
                            <i class="fa fa-circle-o"></i>
                            <span>Per-Game RTP</span>
                        </a>
                    </li>
                </ul>
            </li>
