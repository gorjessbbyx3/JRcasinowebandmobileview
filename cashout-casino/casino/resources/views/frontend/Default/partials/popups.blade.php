...
<div id="registration-confirm" tabindex="-1" role="dialog" class="modal modal-registration" modal-window="" window-class="modal-registration" style="background:transparent; display:none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="registry-modal ng-scope">
                ...
                <div class="registry-modal__wrap">
                    <div class="registry-modal__content">
                        ...
                        <div class="registry-modal__reg-mob-ttl ng-binding">Free Play 2000 Credits in Demo Mode</div>
                    ...
                    <div class="registry-modal__form-wrp">
                        <h2 class="registry-modal__form-ttl ng-binding">Create Demo Account</h2>
                        <form method="post" action="<?= route('frontend.register.post') ?>" ng-submit="sendForm($event)" data-modal-success="#system-notification-success" class="registry-modal__form form form--reg ng-pristine ng-valid ng-isolate-scope">
                            ...
                            <div>
                                <div class="form__step form__step--1">
                                    <div style="text-align: center; margin-bottom: 20px; padding: 15px; background: rgba(255,255,255,0.1); border-radius: 8px;">
                                        <p style="font-size: 14px; margin-bottom: 10px;">Your demo account credentials will be automatically generated.</p>
                                        <p style="font-size: 12px; color: #ffd700;">Please save your username and password after registration!</p>
                                    </div>
                                    
                                    <div class="form__field form__field--age_terms_acceptance form__field--checkbox">
                                        <label class="checkbox-elem">
                                            <input class="checkbox-elem__input ng-pristine ng-untouched ng-valid ng-empty" type="checkbox" name="age_confirmation" id="age_confirmation" required>
                                    ...
                                    <div class="form__field form__field--demo_disclaimer form__field--checkbox" style="margin-top: 15px;">
                                        <label class="checkbox-elem">
                                            <input class="checkbox-elem__input ng-pristine ng-untouched ng-valid ng-empty" type="checkbox" name="demo_disclaimer" id="demo_disclaimer" required>
                                            <span class="checkbox-elem__icon icon-woo"></span> 
                                            <span class="checkbox-elem__text">
                                                <span class="ng-binding" style="font-size: 13px;">
                                                    I understand that demo accounts cannot redeem any points and will be automatically deleted after 7 days.
                                                </span>
                                                <sup class="checkbox-elem__required">*</sup>
                                            </span>
                                        </label>
                            ...
                            <div class="form__btn-wrp">
                                <input class="button button-primary ng-scope" type="submit" value="Play Demo">
                            </div>
...
<div class="modal" id="system-notification-success" style="display:none">
        <header class="modal__header">
                <div class="span modal__title">Demo Account Created!</div>
                <span ng-click="closeModal($event)" class="modal__icon icon icon_cancel js-close-popup"></span>
        </header>
        <div class="modal__content">
                <div id="system-notification-success-text" class="modal-text"></div>
                <div id="demo-credentials-container" style="display:none; margin-top: 20px;">
                        <p style="font-weight: bold; color: #ffd700; margin-bottom: 15px;">⚠️ Save these credentials - they will only be shown once!</p>
                        <div style="margin-bottom: 15px;">
                                <label style="display: block; margin-bottom: 5px; font-weight: bold;">Username:</label>
                                <input type="text" id="demo-username-field" readonly style="width: 100%; padding: 10px; border: 2px solid #ffd700; border-radius: 4px; background: #f5f5f5; font-size: 14px; font-weight: bold;" onclick="this.select()">
                        </div>
                        <div style="margin-bottom: 15px;">
                                <label style="display: block; margin-bottom: 5px; font-weight: bold;">Password:</label>
                                <input type="text" id="demo-password-field" readonly style="width: 100%; padding: 10px; border: 2px solid #ffd700; border-radius: 4px; background: #f5f5f5; font-size: 14px; font-weight: bold;" onclick="this.select()">
                        </div>
                        <p style="font-size: 12px; color: #888; font-style: italic;">Click on each field to select and copy the text</p>
                </div>
        </div>
        <div class="popup__footer">
                <input ng-click="closeModal($event)" type="submit" value="Close" class="popup__button button" />
